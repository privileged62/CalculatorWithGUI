...
cal=Tk()
cal.title("İntelligent calculator")
operator=""
...
ex=Button(cal,padx=16,pady=16,bd=8,fg="black",font=('arial',20,'bold'),
...
btnEquals=Button(cal,width=18,padx=16,pady=16,bd=8,fg="black",font=('arial',20,'bold'),
            text="=",bg="powder blue",command=btnEqualsInput).grid(row=5,column=0,columnspan=4)
